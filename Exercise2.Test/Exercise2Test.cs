...
namespace Exercise2.Test
{
    public class UnitTest1
    {
        ...
        {            
            Assert.True(IsPropertyReadOnly<ImmutableStudent>("Status"));
        }
        ...
        {
            // Arrange
            var student = new ImmutableStudent(1, "Rasmus", "Lysstrøm", new DateTime(2021, 9, 16), new DateTime(2024, 7, 20), new DateTime(2024, 7, 20));
        ...
        public void Status_Returns_Correctly(string start, string end, string? graduation, Status expected) 
        {
            ...
            var student = new ImmutableStudent(1, "Name", "Surname", startDate, endDate, graduationDate);
